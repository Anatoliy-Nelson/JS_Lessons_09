...
const filter = (array, callback) => {
  // Создаем новый массив, который будет содержать отфильтрованные элементы
  const result = [];

  // Проходим по каждому элементу массива
  for (let i = 0; i < array.length; i++) {
    // Если callback возвращает true для текущего элемента, добавляем его в результирующий массив
